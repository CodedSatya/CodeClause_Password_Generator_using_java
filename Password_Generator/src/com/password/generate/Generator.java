...
import java.util.*;
import com.password.security.Encrypter;
...
public class Generator {
	...
	public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, IOException {
		...
		String path ="C:\\Users\\satya\\OneDrive\\Desktop\\CodeClause( Passwowd Generator )\\Password_Generator\\Passwords\\"+passFor+"_Password.txt";
